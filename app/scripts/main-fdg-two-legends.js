...
(function () {
    ...
    function forceLayoutEx1() {
        ...
        function visualizeGraphData(error, json) {
                ...
                // Note: This legend generated using the xScale (commented out, above) works just fine, but alignment becomes
                // an issue depending on the horizontal width of the browser.  
                //

                /*var svgLegend = d3.select('.force-ex-1-legend')
                    .append('svg')
                    .attr('width', w)
                    .attr('height', 50);
                */
                ...
                var bars = legendGroup.selectAll('rect')
                                    .data(dataset.nodes)
                                    .enter()
                                    .append('rect');
                var labels = legendGroup.selectAll('text')
                                    .data(dataset.nodes)
                                    .enter()
                                    .append('text');
                ...
                labels.text(function(d) { return d.legendName; })
                      .attr('x', function(d, i) { 

                        switch (d.name.length) {

                            case 3: 
                                return 1.50 + xScale(i);
                                break;

                            case 4: 
                                return 0.75 + xScale(i);
                                break;

                            case 5:
                                return 0.20 + xScale(i);
                                break;
