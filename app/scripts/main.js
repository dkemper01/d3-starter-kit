...
'use strict';
	...
	function showFabMenu() {
		...
		TweenMax.to(".mdl-layout__tab-bar > button > svg > circle", 0.5, {
			attr: {
				"r": 240,
				"fill": "rgb(85, 139, 47)"
			},
		...
		TweenMax.to(".header__fab-menu", 0.5, {
			right: "5.5em",
			opacity: "1.0",
			ease: Power2.easeOut
		});
	...
	function tabBarScrollEaseLeft() {
		
		var toScroll = this.tabBar_.scrollLeft - this.Constant_.TAB_SCROLL_PIXELS;
		TweenMax.to(this.tabBar_, 0.75, {"scrollLeft": toScroll, "ease": Power2.easeInOut});

	}
	
	function tabBarScrollEaseRight() {
	...
	componentHandler.registerInterceptors('MaterialLayout', [ {"componentName": "leftButton", "handler": tabBarScrollEaseLeft, "eventName": "click"}, {"componentName": "rightButton", "handler": tabBarScrollEaseRight, "eventName": "click"} ]);
