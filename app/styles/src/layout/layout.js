...
(function() {
  ...
  */
    ...
    if (this.element_) {
      ...
      if (this.header_ && this.tabBar_) {
        ...
        for (var i = 0; i < tabs.length; i++) {
          new MaterialLayoutTab(tabs[i], tabs, panels, this, layoutCallbacks);
        }
      }
   ...
   * @param {!Array<Function>} layoutCallbacks Array of callbacks to invoke when a tab is clicked.
   */
  function MaterialLayoutTab(tab, tabs, panels, layout, layoutCallbacks) {
    ...
    tab.addEventListener('click', function(e) {
      ...
      if (tab.getAttribute('href').charAt(0) === '#') {
        ...
        for (var c = 0; c < layoutCallbacks.length; c++) {
            layoutCallbacks[c]();
        }
      }
    });
