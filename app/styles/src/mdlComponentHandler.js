...
var componentHandler = {
  ...
  */
  registerTabSelectedCallback: function(jsClass, callback) {},
   ...
   */
   findCreatedComponentByNode: function(node) {}
};
...
componentHandler = (function() {
  ...
  function upgradeElementInternal(element, optJsClass) {
    ...
    for (var i = 0, n = classesToUpgrade.length, registeredClass; i < n; i++) {
      ...
      if (registeredClass) {
        ...
        //
        console.log("registered: " + registeredClass.className);
  ...
  return {
    ...
    findCreatedComponentByNode: findCreatedComponentByNodeInternal
  };
})();
